"""
Produces a single PDF with one subplot per backbone (all 5 CIFAR-10 QIT runs).
Usage:
    python scripts/plot_cifar10_all.py
    python scripts/plot_cifar10_all.py --out plots/cifar10_all.pdf
"""
...
def main():
    ...
    parser.add_argument("--runs_dir", default="runs",
                        help="Directory containing qit_cifar10_<backbone> subdirs.")
    parser.add_argument("--out", default="plots/cifar10_all_backbones.pdf")
    ...
    fig.suptitle("QIT: teacher vs student across quantization regimes — CIFAR-10",
